<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="答题时长(分钟)" prop="time">
          <el-input v-model="ruleForm.time" 
              placeholder="答题时长(分钟)" clearable  :readonly="ro.time"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="答题时长(分钟)" prop="time">
              <el-input v-model="ruleForm.time" 
